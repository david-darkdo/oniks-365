-- ONIKS 365 — CURRENT BUILD: PRODUCT INTELLIGENCE V6 WITH DIFFERENTIATOR & SEARCH INTELLIGENCE
-- 1. Archive previous prompt template (v5) to ai_prompt_templates_history
...
-- 2. Upgrade active product_details prompt template to Version 6
UPDATE public.ai_prompt_templates
SET 
  version = 6,
  updated_at = NOW(),
  purpose = 'Universal Master Prompt V6 — Product Intelligence with Differentiator Context, canonical FAQ generation, comprehensive Search Intelligence arrays, and Nigerian commercial discovery.',
...
7. DIFFERENTIATOR CONTEXT: Use the provided Differentiator Type and Differentiator Note (if present) as key contextual product intelligence to uniquely sharpen the product narrative, highlights, features, benefits, alternative names, search phrases, FAQs, and keywords. Never invent unverified technical specifications from a differentiator.
